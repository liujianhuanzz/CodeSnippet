...
public class TestDeserialize {
    public static void main(String[] args) throws IOException {
        ...
        StarWand starWand = (StarWand)mapper.readValue(starWandStr, Equipment2.class);
        Daedalus daedalus = (Daedalus)mapper.readValue(daedalusStr, Equipment2.class);
        HugeDrink hugeDrink = (HugeDrink)mapper.readValue(hugeDrinkStr, Equipment2.class);
